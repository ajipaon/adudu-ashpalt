import { Button, Dialog, MultiSelectComboBox, TextField, VerticalLayout } from '@vaadin/react-components';
import User from 'Frontend/generated/com/adudu/ashpalt/models/User';
import { UserEndpoint, ChatEndpoint } from 'Frontend/generated/endpoints';
...
export default function CreateGroupModal({ opened, onClose, onCreate }: CreateGroupModalProps) {
    ...
    const footer = (
        <>
            <Button theme="tertiary" onClick={onClose}>Cancel</Button>
            <Button theme="primary" onClick={handleCreate}>Create</Button>
        </>
    );
