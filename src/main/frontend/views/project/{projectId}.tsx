        ...
        >
            ...
            <Dialog headerTitle="New Column" opened={isColumnDialogOpen} onOpenedChanged={(e) => setIsColumnDialogOpen(e.detail.value)}>
                <div className="p-3 flex flex-col gap-3">
                    <TextField label="Name" value={newColumnName} onChange={e => setNewColumnName(e.target.value)} />
                    <Button theme="primary" onClick={handleAddColumn}>Save</Button>
                </div>
            </Dialog>

            <Dialog headerTitle="New Task" opened={isTaskDialogOpen} onOpenedChanged={(e) => setIsTaskDialogOpen(e.detail.value)}>
                <div className="p-3 flex flex-col gap-3">
                    <TextField label="Title" value={newTaskTitle} onChange={e => setNewTaskTitle(e.target.value)} />
                    <Button theme="primary" onClick={handleAddTask}>Save</Button>
                </div>
            </Dialog>
