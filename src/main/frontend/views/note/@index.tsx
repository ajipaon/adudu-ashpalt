...
import { Plus, Trash2, Share2, Users, Edit2, Check, X } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
            <div className="max-w-6xl mx-auto">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border-t pt-4">
                                <label className="flex items-center mb-3">
                                    ...
                                    />
                                    <span className="ml-2 text-sm font-medium text-gray-700">Buat Publik (Bisa diakses semua tim)</span>
                                </label>
                                ...
                                {!isPublic && (
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                            {teams.filter(t => t.id !== newNote.teamId).map(team => (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {notes.map(note => (
                        <div key={note.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden">
                            {/* Card Header */}
                      ...
                      Publik
                            ...
                            <div className="px-6 py-4">
                                <p className="text-gray-700 text-sm leading-relaxed mb-4 line-clamp-3">{note.content}</p>

                                {/* Meta Info */}
                                <div className="space-y-2 mb-4 pb-4 border-b border-gray-200">
                                    <div className="flex items-center gap-2 text-sm text-gray-600">
                                        <Users size={16} />
                                        <span className="font-medium">Tim: <span className="text-indigo-600">{"note.teamName"}</span></span>
                                    </div>
                ...
                {notes.length === 0 && !isAddingNote && (
                    <div className="text-center py-12">
                        <p className="text-gray-500 text-lg">Belum ada note. Mulai dengan menambah note baru!</p>
                    </div>
                )}
            </div>
        </div>
