    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  return (
                    <div key={meta.id} className="border-l-2 border-blue-500 pl-4">
                      ...
                      <div className="flex items-start gap-3">
                        <div
                          className={`w-3 h-3 mt-1.5 rounded-full ${content.color || 'bg-blue-500'}`}
                        ></div>
                        <div className="flex-1">
                          <div className="text-sm text-gray-700 font-medium">{content.title}</div>
                          {content.startTime && (
        ...
        <div className="bg-white rounded-lg p-6 border border-slate-700">
          ...
          <p className="text-sm text-gray-700 mb-4">Snapshot of your assigned tasks.</p>
